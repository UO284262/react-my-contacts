...
const CardModal = ({ contact }) => {
    ...
    return (
        <div>
            <a className="f6 link dim br3 ph3 pv2 mb2 dib white bg-dark-green"
                onClick={() => setModalOpen(true)} href="#0">More info</a>
            <Modal
            ...
            >
                ...
                <div className="dib mr5">
                    ...
                    <p>City: {contact.location.city}, {contact.location.state}
                        ({contact.location.country})</p>
                    <p>Street: {contact.location.street.name},
                        {contact.location.street.number}</p>
                ...
                <div className="dib">
                    <MapContainer
                        center={[contact.location.coordinates.latitude, contact.location.coordinates.longitude]} zoom={10}>
                        <TileLayer
                ...
                <div className="tc">
                    <a className="f6 link dim br3 ph3 pv2 mb2 dib white bg-dark-blue"
                        onClick={() => setModalOpen(false)} href="#0">Close</a>
                </div>
            </Modal>
        </div>
    );
